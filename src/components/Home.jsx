...
const Home = () => {
  return (
    <div
      name="home"
      className="pb-8 pt-4 sm:pt-12 w-full dark:bg-gradient-to-b dark:from-gray-900 dark:via-dark-emerald dark:to-gray-900 bg-gradient-to-b  from-slate-200 via-slate-300 to-slate-200"
    >
      <div class="mx-auto mb-auto flex flex-col items-center justify-center h-40 px-4 text-center">
