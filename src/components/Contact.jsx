...
const Contact = () => {
  return (
    <div
      name="kontakt"
      className="w-full h-screen p-4 dark:bg-gradient-to-b dark:from-gray-900 dark:via-dark-emerald dark:to-gray-900 bg-gradient-to-b  from-slate-200 via-slate-500 to-slate-200"
    >
