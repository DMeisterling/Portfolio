...
const Security = () => {
  return (
    <div
      name="datenschutz"
      className="h-full w-full dark:bg-gradient-to-b dark:from-gray-900 dark:to-dark-emerald bg-gradient-to-b  from-slate-200 via-slate-500 to-slate-200 mt-10"
    >
      <div class="mx-auto flex flex-col justify-center h-full px-4">
        ...
        <h3 className="h3sec">Datenerfassung auf dieser Website</h3>{" "}
        <h4 className="h4sec">
        ...
        <h4 className="h4sec">Wie erfassen wir Ihre Daten?</h4>{" "}
        <p className="pSec">
        ...
        <h4 className="h4sec">Wof&uuml;r nutzen wir Ihre Daten?</h4>{" "}
        <p className="pSec">
        ...
        <h2 className="h2sec">2. Hosting</h2>
        <p className="pSec">
          Wir hosten die Inhalte unserer Website bei folgenden Anbietern:
        </p>
        <h3 className="h3sec">Externes Hosting</h3>{" "}
        <p className="pSec">
        ...
        <p className="pSec">Wir setzen folgende(n) Hoster ein:</p>
        <p className="pSec">
          Netlify, Inc.
          <br />
          44 Montgomery Street, Suite 300
          <br />
          94104 San Francisco, California, USA
        </p>
        <h4 className="h4sec">Auftragsverarbeitung</h4>{" "}
        <p className="pSec">
        ...
        <h3 className="h3sec">Datenschutz</h3>{" "}
        <p className="pSec">
        ...
        <h3 className="h3sec">Hinweis zur verantwortlichen Stelle</h3>{" "}
        <p className="pSec">
        ...
        <h3 className="h3sec">Speicherdauer</h3>{" "}
        <p className="pSec">
        ...
        <h3 className="h3sec">Recht auf Daten&shy;&uuml;bertrag&shy;barkeit</h3>{" "}
        <p className="pSec">
        ...
        <h3 className="h3sec">Auskunft, Berichtigung und L&ouml;schung</h3>{" "}
        <p className="pSec">
        ...
        <h3 className="h3sec">Recht auf Einschr&auml;nkung der Verarbeitung</h3>{" "}
        <p className="pSec">
        ...
        <h2 className="h2sec">4. Datenerfassung auf dieser Website</h2>
        <h3 className="h3sec">Kontaktformular</h3>{" "}
        <p className="pSec">
        ...
        <h3 className="h3sec">Anfrage per E-Mail, Telefon oder Telefax</h3>{" "}
        <p className="pSec">
        ...
        <h2 className="h2sec">5. Plugins und Tools</h2>
        <h3 className="h3sec">Google Fonts</h3>{" "}
        <p className="pSec">
